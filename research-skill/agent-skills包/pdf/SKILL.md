---
name: pdf
description: 综合 PDF 处理工具包，用于提取文本和表格、创建新 PDF、合并/拆分文档以及处理表单。当 Claude 需要填写 PDF 表单或以编程方式大规模处理、生成或分析 PDF 文档时使用。
...
| 填写 PDF 表单 | pdf-lib 或 pypdf（参阅 forms.md） | 参阅 forms.md |
